...
namespace PetHouse.Areas.Admin.Controllers
{
	...
	public class AdminSuppliersController : Controller
    {
        ...
        public AdminSuppliersController(PetHouseDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Suppliers != null ? 
                          ...
                          Problem("Entity set 'PetHouseDbContext.Suppliers'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Email,PhoneNumber")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Email,PhoneNumber,CreateDate,UpdateDate")] Supplier supplier)
        {
            if (id != supplier.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PetHouseDbContext.Suppliers'  is null.");
            }
            var supplier = await _context.Suppliers.FindAsync(id);
            if (supplier != null)
            {
