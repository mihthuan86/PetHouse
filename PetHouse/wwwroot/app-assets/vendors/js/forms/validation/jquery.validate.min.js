  ...
  a.extend(a.expr.pseudos || a.expr[":"], {
    ...
    a.extend(a.validator, {
      ...
      messages: {
        ...
        email: "Phải đúng định dạng email (Ví dụ: abc@gmail.com).",
        username:"Chỉ chứa kí tự từ a-z hoặc A-Z và chứa số, không chứa dấu cách hoặc kí tự đặc biệt",
        password:"Tối thiểu 8 kí tự, ít nhất 1 chữ cái và 1 số",
        cfpassword:"Tối thiểu 8 kí tự, ít nhất 1 chữ cái và 1 số",
      ...
      methods: {
        ...
        password: function (a,b) {
            return (
                this.optional(b) ||
                /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/.test(a)                
              );
        },               
        cfpassword: function (a,b) {
            return (
                this.optional(b) ||
                /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/.test(a)                
              );
